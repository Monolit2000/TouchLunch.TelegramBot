...
public class MessageClient
{
    ...
    public async Task SetWebhookAsync(string url, int maxConnections = 40, List<UpdateType> allowedUpdates = null)
    {
        await TelegramClient.SetWebhookAsync(url, maxConnections: maxConnections, allowedUpdates: allowedUpdates);
    }
